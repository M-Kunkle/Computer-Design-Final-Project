...
REM
REM Generated by Vivado on Tue May 03 03:26:40 -0500 2022
...
echo "xvlog --incr --relax -prj demux_testbench_vlog.prj"
call xvlog  --incr --relax -prj demux_testbench_vlog.prj -log xvlog.log
